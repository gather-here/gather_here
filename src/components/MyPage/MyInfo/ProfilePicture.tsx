...
const ProfilePictureUpload = () => {
  return (
    <div className="bg-white rounded-2xl border border-gray-200 s:border-none shadow-sm p-7 s:p-0 s:pb-4">
      <label htmlFor="profile-picture" className="block text-lg font-semibold text-gray-700 mb-3">
        프로필 사진
      </label>
      ...
      <div className="mt-5 flex space-x-2">
        ...
        <button type="button" className="px-4 py-2 bg-gray-900 text-white rounded-md text-sm">
          저장
        </button>
      </div>
    </div>
